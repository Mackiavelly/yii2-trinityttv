...
class TrinityApi extends BaseObject {
	 ...
	 * После получения  положительного ответа на это уведомление  от TRINITY-TV  - Партнер фиксирует у себя факт
	 * успешного  подключения услуги абоненту. При этом кнопка/ссылка «Подключить услугу» в личном кабинете на сайте
	 * Партнера (или в другом месте на сайте Партнера) должна быть заменена на другую (например, «Информационный раздел»
	 ...
	 * блокировки услуги абоненту. При такой блокировке услуги пользователь не может воспользоваться сервисом TRINITY-TV,
	 * при этом услуга остается у него активированной (но заблокированной). После получения положительного ответа на это
	 * уведомление от TRINITY-TV - Партнер фиксирует у себя факт успешного восстановления услуги абоненту. Пользователь
	 * может продолжать пользоваться сервисом TRINITY-TV.
	 *
	 * @param string $localId
